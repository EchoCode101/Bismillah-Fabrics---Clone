				...
				<div class="row">
					...
					<div class="col-md-4" id="col">
						...
						<div class="row text-center">
							<div class="col-md-6">
								<a href="#">
									<i class="fa fa-facebook r1" aria-hidden="true"></i>
								</a>
							</div>
							<div class="col-md-6">
								<a href="#">
									<i class="fa fa-whatsapp r1" aria-hidden="true"></i>
								</a>
							</div>
							<div class="col-md-6">
								<a href="#">
									<i class="fa fa-instagram r2" aria-hidden="true"></i>
								</a>
							</div>
							<div class="col-md-6">
								<a href="#">
									<i class="fa fa-twitter r2" aria-hidden="true"></i>
								</a>
							</div>
							<div class="col-md-6">
								<a href="#">
									<i class="fa fa-youtube r3" aria-hidden="true"></i>
								</a>
							</div>
							<div class="col-md-6">
								<a href="#">
									<i class="fa fa-linkedin r3" aria-hidden="true"></i>
								</a>
							</div>
						</div>
					</div>
					<!------- SOCIAL ICONS ------->
					<!-- ADDRESS SECTION -->
					<div class="col-md-4 text-center" id="address">
						<h3>Haleem Akhtar</h3>
